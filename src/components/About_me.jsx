        ...
        <>
            ...
            <div className='p-8 flex gap-8 justify-evenly items-center'>
                ...
                <div className='max-w-3xl'>
                    ...
                    <p className='text-3x0 text-white'>My journey into the world of software was born from a deep curiosity to transform ideas into something real. It was a fascination with the process of creating from scratch, that was the first one to drove me in. Since then, software development has become my passion, as it fulfills my love for constant learning and the challenge of building things that work and provide value.</p>
                </div>
